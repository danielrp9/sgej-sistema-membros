...
import { LayoutGrid, Users, FileCheck, LogOut, Settings } from "lucide-react";
...
export default function Sidebar() {
  ...
  return (
    <aside className="w-64 flex flex-col p-6 h-screen bg-[--bg-sidebar-gradient] text-white border-r border-white/5">
      ...
      <div className="flex items-center gap-3 mb-12 px-2">
        ...
        <span className="text-base font-nasa text-white pt-1">
          NextStep
        </span>
      </div>
