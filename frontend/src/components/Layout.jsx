  ...
  return (
    <div className="flex h-screen bg-[#111315] overflow-hidden">
      ...
      <div className="flex-1 p-3">
        <div className="h-full bg-white rounded-[32px] overflow-hidden flex flex-col shadow-2xl">
          {/* Top Bar Interna */}
          <header className="px-8 py-6 flex items-center justify-between border-b border-gray-50">
            ...
            <div className="flex items-center gap-4">
              <div className="relative group hidden md:block">
                ...
                <input type="text" placeholder="Search for..." className="bg-gray-100 border-none rounded-lg py-2 pl-10 pr-4 text-xs outline-none focus:ring-2 focus:ring-brand-green/20 transition-all" />
              </div>
